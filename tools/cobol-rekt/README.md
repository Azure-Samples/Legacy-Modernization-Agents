...
Each patch replaces a fatal parse abort with a logged, null-safe fallback,
so programs that would otherwise land in deps-only mode keep full
AST/CFG/Data fidelity.

...
{
    /// <summary>
    /// Represents an insurance policy record containing detailed information about the policy,
    /// policy holder, beneficiary, payment details, underwriting, status, and audit timestamps.
    /// </summary>
    public record PolicyRecord
    {
        ...
        /// <summary>
        /// Gets or sets the status of the policy (e.g., Active, Inactive).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the timestamp when the policy was added (format: ISO 8601).
        /// </summary>
        public string PolicyAddTimestamp { get; init; } = string.Empty;

        /// <summary>
        /// Gets or sets the timestamp when the policy was last updated (format: ISO 8601).
        /// </summary>

...
show_usage() {
    ...
    echo -e "  ${CYAN}1.${NC} Drop COBOL into ${GREEN}source/${NC}"
    echo -e "  ${CYAN}2.${NC} ${GREEN}$0 rekt-full${NC}        ${CYAN}# static analysis → Neo4j + output/rekt/${NC}"
    echo -e "  ${CYAN}3.${NC} Portal → ${GREEN}Target Architecture${NC} → ${GREEN}💾 Save${NC}   ${CYAN}# writes target-architecture.json${NC}"
    ...
    echo -e "  ${GREEN}--target COMPONENT${NC}        Convert all programs mapped to a target component (e.g. svc-data)"
    echo -e "  ${GREEN}--keyword TEXT${NC}            Convert all programs that contain a whole-word match"

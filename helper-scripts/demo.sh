...
if [[ ! -f "$REPO_ROOT/.env" ]]; then
    echo "Create .env from .env.example and set NEO4J_PASSWORD before running the demo."
    exit 1
fi
...
if [[ -z "$NEO4J_PASSWORD" ]]; then
    echo "NEO4J_PASSWORD is required in .env."
    exit 1
fi
...
echo "   Username: neo4j"
echo "   Password: the NEO4J_PASSWORD value from .env"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
